    ...
    <div className="min-h-screen bg-background text-ink">
      <div className="max-w-3xl mx-auto px-6 sm:px-10 py-20">
        ...
        <div className="space-y-8 font-body text-sm sm:text-base leading-relaxed text-ink/80">
          <section>
            <h2 className="font-display text-xl font-semibold text-ink mb-2">1. Services</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink mb-2">2. Engagements</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink mb-2">3. Payment</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink mb-2">5. Liability</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink mb-2">6. Contact</h2>
