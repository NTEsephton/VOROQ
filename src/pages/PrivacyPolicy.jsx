    ...
    <div className="min-h-screen bg-white dark:bg-background text-black dark:text-ink">
      <div className="max-w-3xl mx-auto px-6 sm:px-10 py-20">
        ...
        <div className="space-y-8 font-body text-sm sm:text-base leading-relaxed text-black/70 dark:text-ink/80">
          <section>
            <h2 className="font-display text-xl font-semibold text-black dark:text-ink mb-2">1. Information we collect</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-black dark:text-ink mb-2">2. How we use it</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-black dark:text-ink mb-2">3. Data storage</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-black dark:text-ink mb-2">4. Your rights</h2>
            <p>You can request access to, correction of, or deletion of your personal data at any time by emailing VOROQ@voroq.co.uk.</p>
          </section>
          <section>
            <h2 className="font-display text-xl font-semibold text-black dark:text-ink mb-2">5. Contact</h2>
